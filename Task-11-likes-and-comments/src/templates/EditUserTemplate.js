function editUserTemplate(props) {
    ...
    return `
        <div id="${index}" class="container container-with-padding">
        ...
        <form action="" id="uploadPhotoForm">
            ...
            <div>
                <input type="submit" value="Upload" id="uploadAvatarBtn">
            </div>
        </form>
        ...
        <form action="" id="uploadPostForm">
            <div>
                Create post:
                <br>
                <label for="post">Select picture:</label>
                <br>
                <input type="file" name="post" id="post">
                <br>
                <label for="postDescription">Add description:</label>
                <br>
                <textarea name="postDescription" id="postDescription" cols="30" rows="10"></textarea>
            </div>

            <div>
                <input type="submit" value="Upload" id="uploadPostBtn">
            </div>
        </form>
